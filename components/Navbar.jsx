...
function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-4 sm:px-2 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-3xl bg-white/70  border-b-red-800 border-2 font-medium ">
      {/* Logo */}
